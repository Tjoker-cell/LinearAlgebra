...
<body style="background: #f6f5fa;">
	<div class="super-content">
		...
		<br><br>
		矩阵：<INPUT type="text" style="width: 35px;" id="rows" placeholder="0" >&nbsp;行</INPUT>
		<INPUT type="text" style="width: 35px;"id="cols"  placeholder="0" onchange="create()">&nbsp;列</INPUT>
		</div><br>
		<div id="haha">
		<table  id="tf">
		...
		<div style="position: fixed;left: 550px ;top:200px">
				<span style="position: fixed;left: 500px;top:150px;font-size: 18px;">结果为：</span>
...
function getMess(){
	...
	$.ajax({
		...
		type:"post",
		data:{list:list,cols:cols,rows:rows},
...
<!--1. append加载table 必须要有jQuery否则加载不成功
//2.将var cols对象强制转为int，否则js做+时是连接符并不是加法 
3.js中+只有当两边是数字是才为加法
//data:{list:list,cols:cols,rows:rows},data应该这样写否则会传值传到一个一维数组中
	//比如data:"list="+list+"&cols="+cols....到servlet中获取data=req.get....;是data[1]就会出现交表越界
